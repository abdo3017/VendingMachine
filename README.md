...
GO
/****** Object:  Table [dbo].[AspNetUserRoles]    Script Date: 2/14/2024 1:22:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Logs]    Script Date: 2/14/2024 1:22:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Products]    Script Date: 2/14/2024 1:22:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[VendingMachineCoins](
	[Coin] [int] NOT NULL,
	[AvailableAmount] [int] NOT NULL,
 CONSTRAINT [PK_VendingMachineConis] PRIMARY KEY CLUSTERED 
(
	[Coin] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[VendingMachineCoins] ADD  CONSTRAINT [DF_VendingMachineConis_AvailableAmount]  DEFAULT ((0)) FOR [AvailableAmount]
GO
